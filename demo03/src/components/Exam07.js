...
const Exam07 = () => {
    ...
    //입력데이터가 변하면 검사결과가 자동으로 계산되도록 처리해보겠다
    const checkMember = () => {
        ...
        //PW-RE검사
        const pwReMatch = member.memberPw.length===0 ? null :member.memberPw.length > 0 &&
            ...
            <div className="row">
                <div className="col-md-10 offset-md-1">
                    ...
                    `}
                                ...
                                <div className="valid-feedback">유효함</div>
                                <div className="invalid-feedback">불허함</div>
                            </div>
                        </div>
                        <div className="row mt-4">
                            <div className="col">
                    ...
                    `}
                        ...
                        <div className="row mt-4">
                            <div className="col">
                                ...
                                <div className="valid-feedback">비밀번호가 일치함</div>
                                <div className="invalid-feedback">비밀번호가 일치하지 않음</div>
                            </div>
                        </div>
