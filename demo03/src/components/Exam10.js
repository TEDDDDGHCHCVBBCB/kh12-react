        ...
        const newBackup = backup.map(item => {
            if (item.itemNo === target.itemNo) {//target과 같은 번호의 상품만큼은
                return {
                    ...
                    edit: false//edit false 되도록 다시 바꿔
                };
            }
            return item;
        });
                        ...
                        <table className="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th width="%" scope="col">유형</th>
                                    <th width="%" scope="col">관리</th>
                                </tr>
                            </thead>
                            <tbody>
                                {items.map((item, index) => (
                                    item.edit === true ? (<tr className="table-dark" key={item.itemNo}>
                                        <td>{item.itemNo}</td>
                                        <td>
                                    ...
                                    ) : (<tr className="table-dark" key={item.itemNo}>
                                        <td>{item.itemNo}</td>
                                        <td>{item.itemName}</td>
                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">등록하기</h5>
                        ...
                        <div className="modal-body">
                            <div className="row">
                                <div className="col">
                                    ...
                                    <input name="itemName" value={data.itemName} onChange={changeData} className="form-control" />
                                </div>
                            </div>
                            <div className="row">
                                <div className="col">
                                    <label className="form-label">상품가격</label>
                                    <input name="itemPrice" value={data.itemPrice} onChange={changeData} className="form-control" />
                                </div>
                            </div>
                            <div className="row">
                                <div className="col">
                                    <label className="form-label">상품분류</label>
                                    <input name="itemType" value={data.itemType} onChange={changeData} className="form-control" />
                                </div>
                            </div>
